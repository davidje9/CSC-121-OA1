#textbook's 4-10 gave a choice of which code to use; but since Moodle requires I use "more guests sorted", preserving earlier work but commented out
"""
...
print(f"The last three items in the list are: {cubes[-1-2:]}")
"""
