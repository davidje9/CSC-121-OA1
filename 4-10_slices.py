...
#updated guest list for larger table
print("Great news! We found a bigger table for David's birthday, which means \
more scintillating conversation and, of course, more presents.\n")
guest_list.insert(0, "Keanu Reeves")
guest_list.insert(2,"Patti Smith")
guest_list.append("Nick Cave")
invite_body = f"\nJoin {len(guest_list)} \
illustrious guests for a night of drink and discussion! {invite_body}"
...
print(f"The first three items in the list are: {guest_list[:3]}")
print(f"Three items from the middle of the list are: {guest_list[2:5]}")
print(f"The last three items in the list are: {guest_list[-1-2:]}")
